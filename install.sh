...
echo ""
echo -e "Optional AI Engine (Qwen2.5 0.5B Instruct Q4_K_M):"
echo -e "  Run ${BOLD}${CYAN}ss ai setup${RESET} to enable deep natural language understanding with local LLM!"
